...
<!-- <form class="form-signin text-center ">
  <img class="mb-4" src="images/EcommerceLogo.png" alt="logo" width="72" height="72">
...
<div class="font-sans texteen-900 antialiased">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 text-center">
    <div>
        <a href="/">
    <img src="images/EcommerceLogo.png" alt="logo" width="128" height="128">
</a>
    </div>

    <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
        <form method="POST" action="#">
            <input type="hidden" name="_token" value="Gfs8rbXWQTHR1bNOZzKmyaqGa9BLG3UdzQnSj9vb">
            <div>
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <button type="submit" class="inline-flex items-center px-4 py-2 bg-green-800 border border-transparent rounded-md font-semibold text-xs text-black uppercase tracking-widest hover:bg-green-700 active:bg-green-900 focus:outline-none focus:border-green-900 focus:ring focus:ring-green-300 disabled:opacity-25 transition ml-4">
                Log in
                </button>
            </div>
        </form>
